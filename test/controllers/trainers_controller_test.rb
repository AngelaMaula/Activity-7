...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { adress: @trainer.adress, current_weight: @trainer.current_weight, email_ad: @trainer.email_ad, gender: @trainer.gender, height: @trainer.height, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { adress: @trainer.adress, current_weight: @trainer.current_weight, email_ad: @trainer.email_ad, gender: @trainer.gender, height: @trainer.height, name: @trainer.name } }
